<template>
  <div class="h-screen overflow-scroll relative">
    ...
    <HeaderSection :back-btn="backBtn" :header-label="headerLabel" :header-bold="headerBold" class="fixed px-4 w-full z-20 bg-white nh-header pt-12 md:pt-2">
      <slot name="Header" />
      <Avatar :name="user?.name" width="w-12" height="h-12" />
    </HeaderSection>
    <div class="h-[110px] md:h-[67px] w-full bg-transparent z-20"></div>
    <!-- *** -->
